...
% ModulFit function 
CostFunction=@(GA_thetaHalf) ModulFit(GA_thetaHalf);     % Cost Function

VarSize=[16 1];   % Decision Variables Matrix Size 

VarMin=0.5;         % Lower Bound of Variables 
VarMax= 3.444;         % Upper Bound of Variables
...
for it=1:MaxIt
    ...
    for k=1:nm
        ...
        % Check         
        %popm(k).Position=checking(popm(k).Position,radius,VarMax,VarMin);
        % Evaluate Mutant
